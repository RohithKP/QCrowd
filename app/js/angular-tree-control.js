    ...
    */
    ...
    return {
      ...
      controller: ['$scope', '$templateCache', '$interpolate', 'treeConfig', function( $scope, $templateCache, $interpolate, treeConfig ) {
        //custom added
        $scope.findValue = function(data, value,path,ref){
          ...
          for(var prop in data) {
            var result = $scope.findValue(data[prop],value,path === undefined ? "['" + prop + "']" : path + "['" + prop + "']" ,ref);
        ...
        $scope.$on('rename', function (event,currentNode) {
          $scope.targetNode = $scope.findValue($scope.treeModel,currentNode.id,undefined,$scope.treeModel);
          $scope.targetNode.title= currentNode.title;
          $scope.targetNode.description = currentNode.description;
        });
