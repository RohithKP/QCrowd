angular.module('QCrowd').controller('TabsDemoCtrl', function ($scope, $window) {
  $scope.projects =  [{"id":0,"name":"Marius Lorem","status":{"text":"passed","percent":50},"browsers":[{"name":"firefox","status":1},{"name":"chrome","status":0},{"name":"safari","status":-1},{"name":"opera","status":1}],"user":{"id":1,"imgUrl":"assets/images/users/one.jpg","name":"Alex Paul"}},
