angular.module('QCrowd').controller('TabsDemoCtrl', function ($scope, $window) {
  $scope.projects =  [{"id":0,"name":"Marius Lorem","status":{"text":"passed","percent":45},"browsers":[{"name":"firefox","status":1},{"name":"chrome","status":0},{"name":"safari","status":-1},{"name":"opera","status":1}],"user":{"id":1,"imgUrl":"assets/images/users/one.jpg","name":"Alex Paul"}},
                    ...
                    {"id":2,"name":"Dk sure rem","status":{"text":"failed","percent":75},"browsers":[{"name":"firefox","status":-1},{"name":"chrome","status":0},{"name":"safari","status":0},{"name":"opera","status":0}],"user":{"id":3,"imgUrl":"assets/images/users/two.jpg","name":"Julie Ann"}},
                  {"id":3,"name":"savi main","status":{"text":"passed","percent":100},"browsers":[{"name":"firefox","status":-1},{"name":"chrome","status":1},{"name":"safari","status":1},{"name":"opera","status":1}],"user":{"id":4,"imgUrl":"assets/images/users/two.jpg","name":"Akshaya"}},
                {"id":4,"name":"savi main","status":{"text":"passed","percent":100},"browsers":[{"name":"firefox","status":-1},{"name":"chrome","status":1},{"name":"safari","status":1},{"name":"opera","status":1}],"user":{"id":5,"imgUrl":"assets/images/users/two.jpg","name":"Akshaya"}}];
  $scope.tabs = [
